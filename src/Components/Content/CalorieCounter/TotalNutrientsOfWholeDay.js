...
export default function TotalNutrientsOfWholeDay(props) {
  let sumOfTotalCalories = 0,
    sumOfTotalProtiens = 0,
    sumOfTotalCarbs = 0,
    sumOfFats = 0,
    sumOfSugar = 0,
    sumOfWater = 0;
  ...
  let ans = props.mealArr.map((meal, index) => {
    sumOfTotalCalories =
      Number(
        props.totalNutrients[meal].totalCalories === undefined
          ? 0
          : props.totalNutrients[meal].totalCalories
      ) + Number(sumOfTotalCalories);
    sumOfTotalProtiens =
      Number(
        props.totalNutrients[meal].protein === undefined
          ? 0
          : props.totalNutrients[meal].protein
      ) + Number(sumOfTotalProtiens);
    sumOfTotalCarbs =
      Number(
        props.totalNutrients[meal].carbs === undefined
          ? 0
          : props.totalNutrients[meal].carbs
      ) + Number(sumOfTotalCarbs);
    sumOfFats =
      Number(
        props.totalNutrients[meal].fats === undefined
          ? 0
          : props.totalNutrients[meal].fats
      ) + Number(sumOfFats);
    sumOfSugar =
      Number(
        props.totalNutrients[meal].sugar === undefined
          ? 0
          : props.totalNutrients[meal].sugar
      ) + Number(sumOfSugar);
    sumOfWater =
      Number(
        props.totalNutrients[meal].water === undefined
          ? 0
          : props.totalNutrients[meal].water
      ) + Number(sumOfWater);

    sumOfSodium =
      Number(
        props.totalNutrients[meal].sodium === undefined
          ? 0
          : props.totalNutrients[meal].sodium
      ) + Number(sumOfSodium);
    sumOfMagnesium =
      Number(
        props.totalNutrients[meal].magnesium === undefined
          ? 0
          : props.totalNutrients[meal].magnesium
      ) + Number(sumOfMagnesium);
    sumOfPotassium =
      Number(
        props.totalNutrients[meal].potassium === undefined
          ? 0
          : props.totalNutrients[meal].potassium
      ) + Number(sumOfPotassium);
    sumOfCalcium =
      Number(
        props.totalNutrients[meal].calcium === undefined
          ? 0
          : props.totalNutrients[meal].calcium
      ) + Number(sumOfCalcium);
    sumOfIron =
      Number(
        props.totalNutrients[meal].iron === undefined
          ? 0
          : props.totalNutrients[meal].iron
      ) + Number(sumOfIron);
    sumOfZinc =
      Number(
        props.totalNutrients[meal].zinc === undefined
          ? 0
          : props.totalNutrients[meal].zinc
      ) + Number(sumOfZinc);
    sumOfFolate =
      Number(
        props.totalNutrients[meal].folate === undefined
          ? 0
          : props.totalNutrients[meal].folate
      ) + Number(sumOfFolate);
    sumOfVitaminB6 =
      Number(
        props.totalNutrients[meal].vitaminB6 === undefined
          ? 0
          : props.totalNutrients[meal].vitaminB6
      ) + Number(sumOfVitaminB6);
    sumOfVitaminC =
      Number(
        props.totalNutrients[meal].vitaminC === undefined
          ? 0
          : props.totalNutrients[meal].vitaminC
      ) + Number(sumOfVitaminC);
    sumOfVitaminD =
      Number(
        props.totalNutrients[meal].vitaminD === undefined
          ? 0
          : props.totalNutrients[meal].vitaminD
      ) + Number(sumOfVitaminD);
  ...
  return (
    <div className="totalNutrientsOfWholeDay">
      ...
      >
        <AccordionSummary
          expandIcon={
            props.expandAccordian === "totalNutrients" ? (
              <RemoveIcon
                className="accordion-expandIcon"
                style={{ color: "red" }}
              />
            ) : (
              <AddIcon className="accordion-expandIcon" fontSize="large" />
            )
          }
