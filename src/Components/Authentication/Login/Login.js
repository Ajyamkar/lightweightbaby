    ...
    if (this.state.error.email === "") {
      axios
        ...
        .then((result) => {
          ...
          if (result.status === 206) {
            this.setState({
              error: {
                ...this.state.error,
                authentication: "user not found try to join",
              },
            });
          }
        ...
        .catch((err) => {
          ...
          // if (err.status === 500) {
          this.setState({
            error: { ...this.state.error, password: "incorrect password" },
          });
          // }
        });
    }
    ...
    return (
      <div className="login">
        <div className="login-main-div">
          <h1 style={{ paddingTop: "15px" }} className="login-h1">
            Login
          </h1>
          <div
            onClick={() => {
          ...
          <div
            onClick={() => {
              window.location.href =
                "http://localhost:9000/auth/fbAuth?forLogin=true";
            }}
            className="social-login-btn"
          >
            {" "}
