        ...
        return (
            <div className="Join">
                <div className="Join-main-div">
                    ...
                    <div onClick={()=>{window.location.href='https://light-weight-baby-node.herokuapp.com/auth/googleAuth'}} className="social-Join-btn"> <img className="social-Join-icon" src={GoogleIcon} alt="google-icon" /> Join with Google </div>
                    <div onClick={()=>{window.location.href='https://light-weight-baby-node.herokuapp.com/auth/fbAuth'}}className="social-Join-btn"> <img className="social-Join-icon" src={FacebookIcon} alt="facebook-icon" /> Join with Facebook </div>
